                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            ...
                            <form method="post" class="form-horizontal"
                                  action="{{ route('backend.coupon.update',$coupon->id) }}"
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-group ">
                                                    ...
                                                    <input type="text" class="form-control" id="coupon_code"
                                                           ...
                                                           value="{{ (!empty(old('coupon_code'))) ? old('coupon_code'): $coupon->coupon_code }}">
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-group ">
                                                    ...
                                                    <input type="number" class="form-control" id="per_day_usage"
                                                           ...
                                                           value="{{ (!empty(old('per_day_usage'))) ? old('per_day_usage'): $coupon->per_day_usage }}">
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-group ">
                                                    ...
                                                    <input type="date" class="form-control" id="expiration"
                                                           name="expiration"
                                                           placeholder="Enter usage limit per user here"
                                                           value="{{ (!empty(old('expiration'))) ? date('Y-m-d',strtotime(old('expiration'))): date('Y-m-d',strtotime($coupon->expiration)) }}">
