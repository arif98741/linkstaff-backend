                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            ...
                            <form method="post" class="form-horizontal" action="{{ route('backend.service.store') }}"
                                ...
                                @method('post') @csrf
                                <div class="card-body">
                                    <h4 class="card-title">Add {{ request()->get('service_type') }} Service to Site</h4>
                                    <fieldset>
                                        <div class="row">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group ">
                                                        ...
                                                        <select name="service_type" id="service_type" readonly=""
                                                            ...
                                                            <option value="short" @if(request()->get('service_type') =='short') selected @endif>On Demand(Short)</option>
                                                            <option value="long" @if(request()->get('service_type') =='long') selected @endif>Long</option>
                                                        </select>
